...
export const Toolbar = React.forwardRef(({ children, className, variant = "fixed", ...props }, ref) => {
    ...
    return (_jsx("div", { ref: composedRef, role: "toolbar", "aria-label": "toolbar", "data-variant": variant, className: cn("tiptap-toolbar", className), ...props, children: children }));
});
Toolbar.displayName = "Toolbar";
export const ToolbarGroup = React.forwardRef(({ children, className, ...props }, ref) => (_jsx("div", { ref: ref, role: "group", className: cn("tiptap-toolbar-group", className), ...props, children: children })));
ToolbarGroup.displayName = "ToolbarGroup";
export const ToolbarSeparator = React.forwardRef(({ ...props }, ref) => (_jsx(Separator, { ref: ref, orientation: "vertical", decorative: true, ...props })));
