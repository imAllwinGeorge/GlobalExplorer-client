...
const App = () => {
    ...
    return (_jsx("div", { children: _jsxs(SocketContext.Provider, { value: socket, children: [_jsx(GlobalCallListener, {}), _jsxs(Routes, { children: [_jsx(Route, { path: "/*", element: _jsx(UserRoutes, {}) }), _jsx(Route, { path: "/host/*", element: _jsx(HostRoutes, {}) }), _jsx(Route, { path: "/admin/*", element: _jsx(AdminRoutes, {}) }), _jsx(Route, { path: "*", element: _jsx(NotFoundPage, {}) })] })] }) }));
};
export default App;
