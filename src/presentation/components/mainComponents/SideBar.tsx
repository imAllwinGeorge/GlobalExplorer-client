...
const SideBar = ({ role }: SideBarPropsType) => {
  ...
  return (
    <>
      <aside className="fixed left-0 top-0 z-30 lg:hidden w-20 bg-white/95 backdrop-blur-xl border-r border-gray-200/50 min-h-screen flex flex-col items-center py-4">
        <motion.button
          onClick={() => setSidebarOpen(!sidebarOpen)}
          className="p-3 bg-gradient-to-r from-amber-400 to-orange-500 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-200 mb-6"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
        >
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      className="absolute right-0 w-1 h-6 bg-gradient-to-r from-amber-400 to-orange-500 rounded-l-full"
      ...
      <AnimatePresence>
        {sidebarOpen && (
          ...
          >
            ...
            {/* Mobile Sidebar */}
            <motion.aside
              className="relative w-80 max-w-[85vw] bg-white/95 backdrop-blur-xl border-r border-gray-200/50 h-full shadow-2xl ml-20"
              variants={sidebarVariants}
              initial="closed"
              animate="open"
              exit="closed"
